...
<%@ include file="../includes/header.jsp" %>
   ...
   <!-- <div id="page-wrapper"> 헤더에 있다. -->
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" id="event">MBC 아카데미 게시판 리스트</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
      ...
      <script type="text/javascript"> // 자바스크립트 코드임을 명시 사실 안써도 작동은 함
      	...
      	document.getElementById("event").onmouseenter = function() {mouseEnter()};
      	document.getElementById("event").onmouseleave = function() {mouseLeave()};

      	function mouseEnter() {
      	  document.getElementById("event").innerHTML = "MBC 아카데미 개판 리스트";
      	}

      	function mouseLeave() {
      	  document.getElementById("event").innerHTML = "MBC 아카데미 게시판 리스트";
      	}
