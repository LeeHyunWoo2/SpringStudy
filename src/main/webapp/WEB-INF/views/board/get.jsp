		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<button data-oper='modify' class="btn btn-default"
					onclick="a href='/board/modify?bno=<c:out value="${board.bno}"/>'">수정</button>
				...
				<form id='operForm' action="/boad/modify" method="get">
					<input type='hidden' id='bno' name='bno'
						...
						value='<c:out value="${ pge.pageNum }"/>'> <input
						type='hidden' name='amount'
						value='<c:out value="${ pge.amount }"/>'> <input
						type='hidden' name='keyword'
						value='<c:out value="${ pge.keyword }"/>'> <input
						type='hidden' name='type' value='<c:out value="${ pge.type }"/>'>
				</form>
