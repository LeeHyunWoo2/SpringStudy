...
public class MemberControllerTests {
	...
	public void testRegister()throws Exception{
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/member/registerMember")
				.param("id", "dsa")
				.param("pw", "333")
				.param("name", "테스트맨"))
				.andReturn()		// 결과를
	...
	public void testGet()throws Exception{
		log.info("결과 : " +
				mockMvc.perform(MockMvcRequestBuilders.get("/member/getMember")
				.param("id", "dsa"))
				.andReturn()		//결과를
				.getModelAndView()
	...
	public void testModify()throws Exception{
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/member/modifyMember")
				.param("id", "dsa")
				.param("pw", "123")
				.param("name", "크악"))
				.andReturn()
	...
	public void testRemove() throws Exception{
		String resultPage = mockMvc.perform(MockMvcRequestBuilders.post("/member/removeMember")
				.param("id", "dsa"))
